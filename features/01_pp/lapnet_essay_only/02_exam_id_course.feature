...
Background:
  ...
  And   I select "LAPNET Essay Only" from 1st Course dropdown :pass
  And   I select "LAPNET Essay Only" from 2nd Course dropdown :pass

Scenario: Next
  When  I click Next :pass
  Then  I see "Re-confirm carefully..." :pass
  And   I see "Exam ID 1234" :pass
  And   I see "Course LAPNET Essay Only" :pass
