...
Background:
  ...
  And   I select "OPEN LAP MC only" from 1st Course dropdown :pass
  And   I select "OPEN LAP MC only" from 2nd Course dropdown :pass

Scenario: Next
  When  I click Next :pass
  Then  I see "Re-confirm carefully..." :pass
  And   I see "Exam ID 1234" :pass
  And   I see "Course OPEN LAP MC only" :pass
