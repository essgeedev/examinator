...
Background:
  ...
  And   I select "OPEN LAP Essay Only" from 1st Course dropdown :pending
  And   I select "OPEN LAP Essay Only" from 2nd Course dropdown :pending

Scenario: Next
  When  I click Next :pending
  Then  I see "Re-confirm carefully..." :pending
  And   I see "Exam ID 1234" :pending
  And   I see "Course OPEN LAP Essay Only" :pending
